...
curl --fail https://cdnjs.cloudflare.com/ajax/libs/coffee-script/1.6.3/coffee-script.min.js \
    > public/lib/coffee-script.js
curl --fail https://cdnjs.cloudflare.com/ajax/libs/less.js/1.4.1/less.min.js \
    > public/lib/less.js
