...
function createGraph() {
 ...
 .text("tooltip");
  ...
  .on("mouseout", function () { return tooltip.style("visibility", "hidden"); })
    ...
    node.append("circle")
  .attr("r", function (d) { return d.r; }).on("mouseover", function (d) {
